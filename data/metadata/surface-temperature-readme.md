...
This data package contains the data that powers the chart ["Average monthly surface temperature"](https://ourworldindata.org/grapher/average-monthly-surface-temperature?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website. It was downloaded on March 19, 2026.
